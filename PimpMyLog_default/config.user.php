...
<?php if(realpath(__FILE__)===realpath($_SERVER["SCRIPT_FILENAME"])){header($_SERVER['SERVER_PROTOCOL'].' 404 Not Found');die();}?>
{
        "globals": {
                ...
                "LOGS_MAX"                    : 500,
                "LOGS_REFRESH"                : 0,
                "MAX_SEARCH_LOG_TIME"         : 45,
                "NAV_TITLE"                   : "Insight logs",
                "NOTIFICATION"                : false,
                ...
                "SORT_LOG_FILES"              : "display-insensitive",
        ...
        "badges": {
                "severity": {
                        ...
                        "User Lookup Failed"     : "warning",
                        "Authentication Failed"     : "danger",
                        "Authentication failed: Invalid credentials"     : "warning",
                        "RADIUS Request Rejected"  : "warning",
                        "RADIUS Request Accepted"  : "success",
                        "Allow"     : "success",
                        "Deny"     : "danger"
                },
